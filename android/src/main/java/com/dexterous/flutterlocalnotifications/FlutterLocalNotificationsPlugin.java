...
public class FlutterLocalNotificationsPlugin
  ...
  private static void setupAlarm(
    ...
    // added null check
    if (notificationDetails != null && notificationDetails.scheduleMode != null
        && notificationDetails.scheduleMode.useAllowWhileIdle() == true) {
      setupAllowWhileIdleAlarm(notificationDetails, alarmManager, epochMilli, pendingIntent);
    } else {
      if (notificationDetails != null && notificationDetails.scheduleMode != null
          && notificationDetails.scheduleMode.useExactAlarm() == true) {
